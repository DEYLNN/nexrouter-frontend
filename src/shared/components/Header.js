    ...
    <div ref={ref} style={{ position: "relative" }}>
      ...
      {open && (
        <div style={{
          ...
          boxShadow: "0 10px 24px -20px rgba(17,24,39,0.30)",
    ...
    <div style={{ position: "relative", width: "clamp(120px, 28vw, 200px)" }}>
      ...
      <input
        ...
        style={{
          ...
          background: focused ? "rgba(79,124,255,0.06)" : "rgba(255,255,255,0.56)",
...
export default function Header({ onMenuClick, showMenuButton = true }) {
  ...
  return (
    <header style={{
      ...
      borderRadius: "14px",
      boxShadow: "0 8px 22px -20px rgba(17,24,39,0.28)",
      flexShrink: 0,
      zIndex: 20,
      position: "sticky",
      top: 12,
