...
export const APIKEY_PROVIDERS = {
  ...
  anuma: { id: "anuma", alias: "anm", name: "Anuma", icon: "/providers/anuma.png", color: "#7C3AED", textIcon: "AN", website: "https://portal.anuma.ai", notice: { text: "Masukkan EVM User ID/address. X-API-KEY Anuma fixed dipakai server-side.", apiKeyUrl: "https://portal.anuma.ai" }, serviceKinds: ["llm"] },
  ...
  cavoti: { id: "cavoti", alias: "cv", name: "Cavoti", icon: "/providers/cavoti.svg", color: "#10B981", textIcon: "CV", website: "https://cavoti.com", notice: { text: "OpenAI-compatible Responses API via cavoti.com/v1.", apiKeyUrl: "https://cavoti.com" }, serviceKinds: ["llm"], models: [{ id: "gpt-5.5", name: "GPT-5.5" }] },
