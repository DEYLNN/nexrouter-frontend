...
export const FREE_TIER_PROVIDERS = {
  ...
  aimux: { id: "aimux", alias: "am", name: "AIMux", icon: "hub", color: "#6366F1", textIcon: "AM", website: "https://aimux.id", notice: { text: "OpenAI-compatible AIMux endpoint. Add your AIMux API key.", apiKeyUrl: "https://aimux.id" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://aimux.id/v1/models", type: "openai" } },
