...
export const APIKEY_PROVIDERS = {
  ...
  anuma: { id: "anuma", alias: "anuma", name: "Anuma", icon: "api", color: "#7C3AED", textIcon: "AN", website: "https://portal.anuma.ai", notice: { text: "Masukkan EVM User ID/address. X-API-KEY Anuma fixed dipakai server-side.", apiKeyUrl: "https://portal.anuma.ai" }, serviceKinds: ["llm"] },
