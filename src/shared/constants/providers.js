...
export const FREE_TIER_PROVIDERS = {
  ...
  llm7: { id: "llm7", alias: "llm7", name: "LLM7", icon: "cloud", color: "#0EA5E9", textIcon: "L7", website: "https://llm7.io", noAuth: true, notice: { text: "Free/anonymous OpenAI-compatible aggregator; rate-limited." }, serviceKinds: ["llm"] },
