...
export const APIKEY_PROVIDERS = {
  ...
  husada: { id: "husada", alias: "husada", name: "Husada", icon: "local_hospital", color: "#10B981", textIcon: "HS", website: "https://husada.net", notice: { text: "OpenAI-compatible Husada endpoint.", apiKeyUrl: "https://husada.net" }, serviceKinds: ["llm"], modelsFetcher: { url: "https://husada.net/v1/models", type: "openai" } },
