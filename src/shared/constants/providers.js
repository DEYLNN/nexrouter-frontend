...
export const OAUTH_PROVIDERS = {
  ...
  xai: { id: "xai", alias: "xai", name: "xAI (Grok)", icon: "auto_awesome", color: "#1DA1F2", textIcon: "XA", website: "https://x.ai", notice: { signupUrl: "https://console.x.ai", text: "Sign in with your xAI account for free Grok access. You can also add an API key from console.x.ai instead." }, serviceKinds: ["llm", "imageToText", "webSearch"], searchViaChat: { defaultModel: "grok-4.20-reasoning", pricingUrl: "https://x.ai/api#pricing" } },
...
export const APIKEY_PROVIDERS = {
  ...
  "xai-apikey": { id: "xai-apikey", alias: "xai-ak", name: "xAI (Grok) — API Key", icon: "auto_awesome", color: "#1DA1F2", textIcon: "XA", website: "https://x.ai", notice: { apiKeyUrl: "https://console.x.ai", text: "Enter your xAI API key from console.x.ai. For free-tier OAuth, use the xAI (Grok) entry under OAuth Providers." }, serviceKinds: ["llm", "imageToText", "webSearch"] },
