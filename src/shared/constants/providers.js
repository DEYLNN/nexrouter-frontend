...
export const APIKEY_PROVIDERS = {
  ...
  "xai-apikey": { id: "xai-apikey", alias: "xai-ak", name: "xAI (Grok)", icon: "auto_awesome", color: "#1DA1F2", textIcon: "XA", website: "https://x.ai", notice: { apiKeyUrl: "https://console.x.ai", text: "Enter your xAI API key from console.x.ai." }, serviceKinds: ["llm", "imageToText", "webSearch"] },
