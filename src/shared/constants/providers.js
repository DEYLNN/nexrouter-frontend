...
export const FREE_TIER_PROVIDERS = {
  ...
  aimurah: { id: "aimurah", alias: "aim", name: "AIMurah", icon: "/provider-icons/aimurah.png", color: "#6366F1", textIcon: "AIM", website: "https://aimurah.my.id", notice: { apiKeyUrl: "https://aimurah.my.id" }, serviceKinds: ["llm"] },
  ...
  sambanova: { id: "sambanova", alias: "sambanova", name: "SambaNova", icon: "speed", color: "#7C3AED", textIcon: "SN", website: "https://cloud.sambanova.ai", notice: { text: "Developer free tier; OpenAI-compatible endpoint.", apiKeyUrl: "https://cloud.sambanova.ai/apis" }, serviceKinds: ["llm"] },
  "github-models": { id: "github-models", alias: "ghm", name: "GitHub Models", icon: "code", color: "#333333", textIcon: "GM", website: "https://github.com/marketplace/models", notice: { text: "GitHub Models free tier for experimentation/prototyping.", apiKeyUrl: "https://github.com/settings/tokens" }, serviceKinds: ["llm"] },
  kilo: { id: "kilo", alias: "kilo", name: "Kilo Gateway", icon: "route", color: "#FF6B35", textIcon: "KG", website: "https://kilo.ai", notice: { text: "Kilo gateway free routes; anonymous/IP-limited or API key for higher limit.", apiKeyUrl: "https://kilo.ai" }, serviceKinds: ["llm"] },
  pollinations: { id: "pollinations", alias: "pollinations", name: "Pollinations", icon: "auto_awesome", color: "#22C55E", textIcon: "PO", website: "https://pollinations.ai", noAuth: true, notice: { text: "Anonymous OpenAI-compatible text endpoint." }, serviceKinds: ["llm"] },
  llm7: { id: "llm7", alias: "llm7", name: "LLM7", icon: "https://llm7.io/llm7.png", color: "#0EA5E9", textIcon: "L7", website: "https://llm7.io", notice: { text: "OpenAI-compatible aggregator with free plan; add your LLM7 API key.", apiKeyUrl: "https://llm7.io" }, serviceKinds: ["llm"] },
