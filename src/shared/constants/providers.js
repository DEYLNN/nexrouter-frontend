...
export const APIKEY_PROVIDERS = {
  ...
  xai: { id: "xai", alias: "xai", name: "xAI (Grok)", icon: "auto_awesome", color: "#1DA1F2", textIcon: "XA", website: "https://x.ai", authType: "oauth", notice: { signupUrl: "https://console.x.ai", text: "Sign in with your xAI account for free Grok access. You can also add an API key from console.x.ai instead." }, serviceKinds: ["llm", "imageToText", "webSearch"], searchViaChat: { defaultModel: "grok-4.20-reasoning", pricingUrl: "https://x.ai/api#pricing" } },
